...
This file provides Codex guidance for this project. Keep the parallel
`CLAUDE.md` aligned with this file. Both are authoritative; translate
...
- Read local `AGENTS.md` and `CLAUDE.md` files before editing.
- Check `git status --short --branch`.
- Inspect the project manifest before running commands, such as `package.json`,
